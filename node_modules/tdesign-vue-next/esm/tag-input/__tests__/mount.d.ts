export declare function getTagInputDefaultMount(props: {}, events: any): import("@vue/test-utils").VueWrapper<Partial<{
    [x: string]: any;
}> & Omit<{
...
export declare function getTagInputValueMount(props: {}, events: any): import("@vue/test-utils").VueWrapper<Partial<{
    [x: string]: any;
}> & Omit<{
    readonly [x: string]: any;
    readonly [x: number]: any;
