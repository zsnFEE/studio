...
import TreeNode from 'tdesign-vue-next/lib/common/js/tree/tree-node';
import { TreeNodeModel, TreeNodeValue } from 'tdesign-vue-next/lib/common/js/tree/types';
export * from './type';
...
export { TreeNode } from 'tdesign-vue-next/lib/common/js/tree/tree-node';
export type { TreeNodeValue } from 'tdesign-vue-next/lib/common/js/tree/types';
export type { TreeOptionData } from 'tdesign-vue-next/lib/common/js/common';
