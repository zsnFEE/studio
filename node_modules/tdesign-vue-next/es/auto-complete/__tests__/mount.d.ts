...
export declare function getNormalAutoCompleteMount(props?: TdAutoCompleteProps, events?: {}): import("@vue/test-utils").VueWrapper<Partial<{
    [x: string]: any;
}> & Omit<{
...
export declare function getOptionSlotAutoCompleteMount(props?: TdAutoCompleteProps, events?: {}): import("@vue/test-utils").VueWrapper<Partial<{
    [x: string]: any;
}> & Omit<{
    readonly [x: string]: any;
    readonly [x: number]: any;
