...
declare const _default: {
    ...
    readonly pagination: {
        ...
        readonly page: "";
        readonly total: "no items | 1 item | {count} items";
    };
    readonly cascader: {
        readonly empty: "Empty Data";
    ...
    readonly table: {
        ...
        readonly searchResultText: "Search \"{result}\". Found no items. | Search \"{result}\". Found 1 item. | Search \"{result}\". Found {count} items.";
    };
    readonly select: {
        readonly empty: "Empty Data";
        readonly loadingText: "loading...";
    ...
    readonly chat: {
        ...
        readonly loadingText: "thinking...";
        readonly loadingEndText: "deep thinking end";
        readonly uploadImageText: "upload image";
        readonly uploadAttachmentText: "upload attachment";
    };
    readonly qrcode: {
        readonly expiredText: "expired";
        readonly refreshText: "refresh";
        readonly scannedText: "scanned";
    };
};
