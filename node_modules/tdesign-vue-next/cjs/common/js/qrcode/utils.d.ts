import type { CrossOrigin, ERROR_LEVEL_MAPPED_TYPE, ErrorCorrectionLevel, Excavation, ImageSettings, Modules } from './types';
...
export declare const generatePath: (modules: Modules, margin?: number) => string;
export declare const excavateModules: (modules: Modules, excavation: Excavation) => boolean[][];
export declare const getImageSettings: (cells: Modules, size: number, margin: number, imageSettings?: ImageSettings) => null | {
    x: number;
    y: number;
    h: number;
    w: number;
