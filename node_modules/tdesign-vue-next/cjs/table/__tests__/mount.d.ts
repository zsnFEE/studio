export declare function getNormalTableMount(props?: {}): import("@vue/test-utils").VueWrapper<Partial<{
    [x: string]: any;
}> & Omit<{
...
export declare function getEmptyDataTableMount(props?: {}): import("@vue/test-utils").VueWrapper<Partial<{
    [x: string]: any;
}> & Omit<{
    readonly [x: string]: any;
    readonly [x: number]: any;
