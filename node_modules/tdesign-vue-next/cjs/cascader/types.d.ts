...
import TreeNode from 'tdesign-vue-next/cjs/common/js/tree/tree-node';
import { TreeNodeModel, TreeNodeValue } from 'tdesign-vue-next/cjs/common/js/tree/types';
export * from './type';
...
export { TreeNode } from 'tdesign-vue-next/cjs/common/js/tree/tree-node';
export type { TreeNodeValue } from 'tdesign-vue-next/cjs/common/js/tree/types';
export type { TreeOptionData } from 'tdesign-vue-next/cjs/common/js/common';
