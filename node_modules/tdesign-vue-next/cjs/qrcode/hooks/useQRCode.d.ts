import { QrCode } from 'tdesign-vue-next/cjs/common/js/qrcode/qrcodegen';
import type { CrossOrigin, ErrorCorrectionLevel, Excavation, ImageSettings } from 'tdesign-vue-next/cjs/common/js/qrcode/types';
