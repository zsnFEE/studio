export declare function getTimelineDefaultMount(props: any, events: any): import("@vue/test-utils").VueWrapper<Partial<{
    [x: string]: any;
}> & Omit<{
...
export declare function getTimelineItemMount(props: any): import("@vue/test-utils").VueWrapper<Partial<{
    [x: string]: any;
}> & Omit<{
    readonly [x: string]: any;
    readonly [x: number]: any;
